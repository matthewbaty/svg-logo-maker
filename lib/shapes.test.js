...
describe('Shapes', () => {
    describe('Square', () => {
        it('should return a square svg with user input', () => {
            ...
            expect(square).toContain(`<svg version=\"1.1\" width=\"300\" height=\"200\" xmlns=\"http://www.w3.org/2000/svg\">·
            <rect width=\"300\" height=\"200\" fill=\"white\" />·
            <text x=\"50%\" y=\"50%\" text-anchor=\"middle\" fill=\"black\" font-size=\"60\">img</text>·
          </svg>`);
        });
    });
});
...
describe('Shapes', () => {
    describe('Circle', () => {
        it('should return a circle svg with user input', () => {
            ...
            expect(circle).toContain('<rect fill="black" circle cx="150" cy="100" r="100" />');
        });
    });
});
...
describe('Shapes', () => {
    describe('Triangle', () => {
        it('should return a triangle svg with user input', () => {
            ...
            expect(triangle).toContain('<rect fill="black" <polygon points="150, 18 282, 283 18, 283" />');
        });
    });
});
