...
class Circle extends Shape {
    ...
    render() {
        return `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">
          ...
          <text x="150" y="130" text-anchor="middle" fill="${this.textColor}" font-size="60">${this.text}</text>
...
class Triangle extends Shape {
    ...
    render() {
        return `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">
          ...
          <text x="150" y="192" text-anchor="middle" fill="${this.textColor}" font-size="60">${this.text}</text>
